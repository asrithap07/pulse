...
export function makeChecks(apiId: string, apiName: string, healthy = true, seed = 1): Check[] {
  ...
  const now = 1750000000000 // fixed timestamp so SSR and client match
...
export const INITIAL_APIS: Api[] = [
  {
    ...
    lastChecked: '12s ago', checks: makeChecks('api1', 'Payments API', true, 1),
  },
  {
    ...
    lastChecked: '43s ago', checks: makeChecks('api2', 'Auth Service', false, 2),
  },
  {
    ...
    lastChecked: '2m ago', checks: makeChecks('api3', 'User Profile API', true, 3),
  },
  {
    ...
    lastChecked: '8m ago', checks: makeChecks('api4', 'Notification Service', false, 4),
  },
]
...
export const INITIAL_INCIDENTS: Incident[] = [
  {
    ...
    startTime: new Date(1750000000000 - 18 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    startTime: new Date(1750000000000 - 4.5 * 60 * 60 * 1000).toISOString(),
    endTime: new Date(1750000000000 - 3.1 * 60 * 60 * 1000).toISOString(),
